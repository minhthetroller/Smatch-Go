...
func newTestMatchService() *MatchService {
	return &MatchService{images: testImageResolver}
}
...
func TestMapPlayersToDTO(t *testing.T) {
	...
	svc := newTestMatchService()
	resp := svc.mapPlayersToDTO(players)
