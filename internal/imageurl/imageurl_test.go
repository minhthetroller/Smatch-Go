...
func TestResolver_Match_PrependBase(t *testing.T) {
	r := New("http://localhost:4566/smatch-matches", "http://localhost:4566/smatch-profiles")
...
func TestResolver_Profile_PrependBase(t *testing.T) {
	r := New("http://localhost:4566/smatch-matches", "http://localhost:4566/smatch-profiles")
...
func TestResolver_TolerantFullURL(t *testing.T) {
	r := New("http://localhost:4566/smatch-matches", "http://localhost:4566/smatch-profiles")
...
func TestResolver_TrailingSlashNormalization(t *testing.T) {
	r := New("http://localhost:4566/smatch-matches/", "http://localhost:4566/smatch-profiles/")
